...
* [Smile](https://github.com/haifengl/smile) ⭐ 6,415 | 🐛 2 | 🌐 Java | 📅 2026-09-19 - Statistical Machine Intelligence & Learning Engine.
...
* [VarInt](https://github.com/bazelbuild/bazel/blob/master/src/main/java/com/google/devtools/build/lib/util/VarInt.java) ⭐ 25,864 | 🐛 1,776 | 🌐 Java | 📅 2026-09-18 - No-deps variable int implementation without deps (by Bazel).
* [caffeine](https://github.com/ben-manes/caffeine) ⭐ 17,874 | 🐛 1 | 🌐 Java | 📅 2026-09-17 - A high performance caching library for Java 8.
...
* [Chronicle-Queue](https://github.com/OpenHFT/Chronicle-Queue) ⭐ 3,814 | 🐛 49 | 🌐 Java | 📅 2026-09-18 - Micro second messaging that stores everything to disk.
...
* [Chronicle-Map](https://github.com/OpenHFT/Chronicle-Map) ⭐ 2,990 | 🐛 32 | 🌐 Java | 📅 2026-09-19 - In-memory key-value store designed for low-latency and/or multi-process applications.
...
* [Eclipse Collections](https://github.com/eclipse/eclipse-collections) ⭐ 2,649 | 🐛 172 | 🌐 Java | 📅 2026-09-17 - Collections framework for Java.
...
* [hollow](https://github.com/Netflix/hollow) ⭐ 1,371 | 🐛 161 | 🌐 Java | 📅 2026-09-04 - Java library and comprehensive toolset for harnessing small to moderately sized in-memory datasets.
...
* [DSL-JSON](http://github.com/ngs-doo/dsl-json) ⭐ 1,071 | 🐛 49 | 🌐 Java | 📅 2026-09-13 - High performance JSON library with advanced compile-time databinding.
* [hppc](https://github.com/carrotsearch/hppc) ⭐ 1,051 | 🐛 5 | 🌐 Java | 📅 2026-08-13 - High Performance Primitive Collections.
...
* [Chronicle-Bytes](https://github.com/OpenHFT/Chronicle-Bytes) ⭐ 437 | 🐛 10 | 🌐 Java | 📅 2026-09-18 - Low level memory access wrappers.
...
* [Truffle](https://github.com/graalvm/truffle) ⭐ 21,703 | 🐛 848 | 🌐 Java | 📅 2026-09-18 - Framework for implementing languages as simple interpreters.
* [JavaPoet](https://github.com/square/javapoet) ⚠️ Archived - A Java API for generating .java source files.
* [auto](https://github.com/google/auto) ⭐ 10,558 | 🐛 89 | 🌐 Java | 📅 2026-09-18 - A collection of source code generators for Java.
* [error-prone](https://github.com/google/error-prone) ⭐ 7,237 | 🐛 537 | 🌐 Java | 📅 2026-09-19 - Catch common Java mistakes as compile-time errors.
...
* [okhttp](https://github.com/square/okhttp) ⭐ 47,061 | 🐛 153 | 🌐 Kotlin | 📅 2026-09-17 - An HTTP+HTTP/2 client for Android and Java applications.
...
* [Aeron](https://github.com/real-logic/Aeron) ⭐ 8,871 | 🐛 21 | 🌐 Java | 📅 2026-09-18 - Efficient reliable UDP unicast, UDP multicast, and IPC message transport.
...
* [armeria](https://github.com/line/armeria) ⭐ 5,144 | 🐛 710 | 🌐 Java | 📅 2026-09-17 - Asynchronous RPC/API client/server library built on top of Java 8, Netty 4.1, HTTP/2, and Thrift.
...
* [bcc](https://github.com/iovisor/bcc) ⭐ 22,664 | 🐛 1,075 | 🌐 C | 📅 2026-09-19 - Tools for BPF-based Linux IO analysis, networking, monitoring, and more.
* [perf-tools](https://github.com/brendangregg/perf-tools) ⭐ 10,467 | 🐛 56 | 🌐 Shell | 📅 2023-11-22 - Performance analysis tools based on Linux perf\_events (aka perf) and ftrace.
...
* [leakcanary](https://github.com/square/leakcanary) ⭐ 29,994 | 🐛 134 | 🌐 Kotlin | 📅 2026-09-18 - A memory leak detection library for Android and Java.
* [Zipkin](https://github.com/openzipkin/zipkin) ⭐ 17,464 | 🐛 175 | 🌐 Java | 📅 2026-08-06 - A distributed tracing system gather timing data for disparate services developed by Twitter.
* [async-profiler](https://github.com/jvm-profiling-tools/async-profiler) ⭐ 9,154 | 🐛 58 | 🌐 C++ | 📅 2026-09-16 - Sampling CPU profiler for Java featuring AsyncGetCallTrace + perf\_events.
...
* [Swiss Java Knife](https://github.com/aragozin/jvm-tools) ⭐ 3,337 | 🐛 15 | 🌐 Java | 📅 2024-01-26 - Small set of tools for JVM troublshooting, monitoring and profiling.
* [jitwatch](https://github.com/AdoptOpenJDK/jitwatch) ⭐ 3,311 | 🐛 19 | 🌐 Java | 📅 2026-09-18 - Log analyser / visualiser for Java HotSpot JIT compiler.
...
* [Eclipse OpenJ9](https://github.com/eclipse/openj9) ⭐ 3,547 | 🐛 3,263 | 🌐 Java | 📅 2026-09-17 - Eclipse OpenJ9.
* [ParparVM](https://github.com/codenameone/CodenameOne/tree/master/vm) ⭐ 1,867 | 🐛 279 | 🌐 Java | 📅 2026-09-19 - An Open Source Java bytecode to C translator for iOS native development. Designed as a part of the [Codename One](https://www.codenameone.com/) WORA for mobile project.
