...
* [Smile](https://github.com/haifengl/smile) ⭐ 6,415 | 🐛 2 | 🌐 Java | 📅 2026-09-06 - Statistical Machine Intelligence & Learning Engine.

## Memory and concurrency

*Tools and data structures for efficient memory layout and concurrent access.*

* [RxJava](https://github.com/ReactiveX/RxJava) ⭐ 48,204 | 🐛 11 | 🌐 Java | 📅 2026-09-05 - Library for composing asynchronous and event-based programs using observable sequences.
* [VarInt](https://github.com/bazelbuild/bazel/blob/master/src/main/java/com/google/devtools/build/lib/util/VarInt.java) ⭐ 25,811 | 🐛 1,852 | 🌐 Java | 📅 2026-09-06 - No-deps variable int implementation without deps (by Bazel).
* [caffeine](https://github.com/ben-manes/caffeine) ⭐ 17,847 | 🐛 2 | 🌐 Java | 📅 2026-09-06 - A high performance caching library for Java 8.
* [okio](https://github.com/square/okio) ⭐ 9,040 | 🐛 103 | 🌐 Kotlin | 📅 2026-09-04 - Modern Java IO library that do clever things to save CPU and memory.
* [Agera](https://github.com/google/agera) ⚠️ Archived - Reactive Programming for Android by Google.
* [lwjgl3](https://github.com/LWJGL/lwjgl3) ⭐ 5,442 | 🐛 87 | 🌐 Java | 📅 2026-09-03 - Java library that enables cross-platform access to popular native APIs useful in the development of graphics (OpenGL), audio (OpenAL) and parallel computing (OpenCL) applications.
* [wire](https://github.com/square/wire) ⭐ 4,427 | 🐛 169 | 🌐 Kotlin | 📅 2026-09-04 - Clean, lightweight protocol buffers for Android and Java.
...
* [RoaringBitmap](https://github.com/RoaringBitmap/RoaringBitmap) ⭐ 3,923 | 🐛 78 | 🌐 Java | 📅 2026-09-02 - A better compressed bitset in Java.
* [Chronicle-Queue](https://github.com/OpenHFT/Chronicle-Queue) ⭐ 3,806 | 🐛 51 | 🌐 Java | 📅 2026-09-05 - Micro second messaging that stores everything to disk.
* [Simple Binary Encoding](https://github.com/real-logic/simple-binary-encoding) ⭐ 3,503 | 🐛 39 | 🌐 Java | 📅 2026-08-31 - High Performance Message Codec.
...
* [Chronicle-Map](https://github.com/OpenHFT/Chronicle-Map) ⭐ 2,989 | 🐛 33 | 🌐 Java | 📅 2026-08-22 - In-memory key-value store designed for low-latency and/or multi-process applications.
...
* [Eclipse Collections](https://github.com/eclipse/eclipse-collections) ⭐ 2,650 | 🐛 180 | 🌐 Java | 📅 2026-09-05 - Collections framework for Java.
...
* [DSL-JSON](http://github.com/ngs-doo/dsl-json) ⭐ 1,072 | 🐛 49 | 🌐 Java | 📅 2026-06-29 - High performance JSON library with advanced compile-time databinding.
...
* [Chronicle-Bytes](https://github.com/OpenHFT/Chronicle-Bytes) ⭐ 437 | 🐛 15 | 🌐 Java | 📅 2026-09-06 - Low level memory access wrappers.
* [geohash](https://github.com/davidmoten/geo) ⭐ 435 | 🐛 9 | 🌐 Java | 📅 2026-09-04 - Java utility methods for geohashing.
...
* [RTree2D](https://github.com/Sizmek/rtree2d) ⭐ 145 | 🐛 13 | 🌐 Scala | 📅 2026-08-21 - RTree2D is a 2D immutable R-tree with STR (Sort-Tile-Recursive) packing for ultra-fast nearest and intersection queries on plane and spherical surfaces.
...
* [Truffle](https://github.com/graalvm/truffle) ⭐ 21,689 | 🐛 847 | 🌐 Java | 📅 2026-09-06 - Framework for implementing languages as simple interpreters.
* [JavaPoet](https://github.com/square/javapoet) ⚠️ Archived - A Java API for generating .java source files.
* [auto](https://github.com/google/auto) ⭐ 10,554 | 🐛 89 | 🌐 Java | 📅 2026-09-04 - A collection of source code generators for Java.
* [error-prone](https://github.com/google/error-prone) ⭐ 7,232 | 🐛 528 | 🌐 Java | 📅 2026-09-04 - Catch common Java mistakes as compile-time errors.
* [javaparser](https://github.com/javaparser/javaparser) ⭐ 6,148 | 🐛 451 | 🌐 Java | 📅 2026-09-04 - Java 1.8 Parser and Abstract Syntax Tree for Java.
* [TeaVM](https://github.com/konsoletyper/teavm) ⭐ 3,104 | 🐛 184 | 🌐 Java | 📅 2026-09-04 - Ahead-of-time translating compiler (transpiler) from Java bytecode to JavaScript.
...
* [compile-testing](https://github.com/google/compile-testing) ⭐ 722 | 🐛 43 | 🌐 Java | 📅 2026-09-01 - Testing tools for javac and annotation processors.
...
* [okhttp](https://github.com/square/okhttp) ⭐ 47,061 | 🐛 149 | 🌐 Kotlin | 📅 2026-09-06 - An HTTP+HTTP/2 client for Android and Java applications.
...
* [Aeron](https://github.com/real-logic/Aeron) ⭐ 8,843 | 🐛 26 | 🌐 Java | 📅 2026-09-04 - Efficient reliable UDP unicast, UDP multicast, and IPC message transport.
...
* [armeria](https://github.com/line/armeria) ⭐ 5,138 | 🐛 705 | 🌐 Java | 📅 2026-09-03 - Asynchronous RPC/API client/server library built on top of Java 8, Netty 4.1, HTTP/2, and Thrift.
...
* [bcc](https://github.com/iovisor/bcc) ⭐ 22,655 | 🐛 1,074 | 🌐 C | 📅 2026-08-27 - Tools for BPF-based Linux IO analysis, networking, monitoring, and more.
...
* [likwid](https://github.com/RRZE-HPC/likwid) ⭐ 1,939 | 🐛 91 | 🌐 C | 📅 2026-08-19 - Read hardware performance counters on Intel and AMD processors.
...
* [leakcanary](https://github.com/square/leakcanary) ⭐ 29,990 | 🐛 132 | 🌐 Kotlin | 📅 2026-08-31 - A memory leak detection library for Android and Java.
* [Zipkin](https://github.com/openzipkin/zipkin) ⭐ 17,457 | 🐛 175 | 🌐 Java | 📅 2026-08-06 - A distributed tracing system gather timing data for disparate services developed by Twitter.
* [async-profiler](https://github.com/jvm-profiling-tools/async-profiler) ⭐ 9,137 | 🐛 60 | 🌐 C++ | 📅 2026-09-02 - Sampling CPU profiler for Java featuring AsyncGetCallTrace + perf\_events.
* [BTrace](https://github.com/jbachorik/btrace) ⭐ 5,993 | 🐛 7 | 🌐 Java | 📅 2026-09-01 - a safe, dynamic tracing tool for the Java platform.
* [micrometer](https://github.com/micrometer-metrics/micrometer) ⭐ 4,896 | 🐛 307 | 🌐 Java | 📅 2026-09-04 - An application metrics facade for the most popular monitoring tools.
...
* [HotswapAgent](https://github.com/HotswapProjects/HotswapAgent) ⭐ 2,613 | 🐛 107 | 🌐 Java | 📅 2026-08-26 - Redefine classes at runtime and skip the redeploy process.
...
* [J2ObjC](https://github.com/google/j2objc) ⭐ 6,036 | 🐛 147 | 🌐 Java | 📅 2026-09-04 - Translator from Java source to Objective-C code. Keeps shared code between iOS native apps and Android native apps.
* [jvm.go](https://github.com/zxh0/jvm.go) ⭐ 3,599 | 🐛 12 | 🌐 Go | 📅 2019-12-04 - A JVM written in Go.
* [Eclipse OpenJ9](https://github.com/eclipse/openj9) ⭐ 3,543 | 🐛 3,266 | 🌐 Java | 📅 2026-09-05 - Eclipse OpenJ9.
* [ParparVM](https://github.com/codenameone/CodenameOne/tree/master/vm) ⭐ 1,863 | 🐛 280 | 🌐 Java | 📅 2026-09-06 - An Open Source Java bytecode to C translator for iOS native development. Designed as a part of the [Codename One](https://www.codenameone.com/) WORA for mobile project.
...
* [MobiDevelop's RoboVM Fork](https://github.com/MobiVM/robovm) ⭐ 1,041 | 🐛 22 | 🌐 Java | 📅 2026-08-18 - Ahead of time compiler for JVM bytecode targeting iOS, Mac OSX and Linux.
...
* [An introduction to distributed systems](https://github.com/aphyr/distsys-class) ⭐ 9,882 | 🐛 6 | 📅 2025-03-18 - Kyle Kingsbury (author of Jepsen).
