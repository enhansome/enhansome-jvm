...
* [Smile](https://github.com/haifengl/smile) ⭐ 6,414 | 🐛 2 | 🌐 Java | 📅 2026-09-14 - Statistical Machine Intelligence & Learning Engine.
...
* [VarInt](https://github.com/bazelbuild/bazel/blob/master/src/main/java/com/google/devtools/build/lib/util/VarInt.java) ⭐ 25,847 | 🐛 1,761 | 🌐 Java | 📅 2026-09-14 - No-deps variable int implementation without deps (by Bazel).
* [caffeine](https://github.com/ben-manes/caffeine) ⭐ 17,867 | 🐛 1 | 🌐 Java | 📅 2026-09-14 - A high performance caching library for Java 8.
...
* [lwjgl3](https://github.com/LWJGL/lwjgl3) ⭐ 5,450 | 🐛 90 | 🌐 Java | 📅 2026-09-10 - Java library that enables cross-platform access to popular native APIs useful in the development of graphics (OpenGL), audio (OpenAL) and parallel computing (OpenCL) applications.
* [wire](https://github.com/square/wire) ⭐ 4,428 | 🐛 164 | 🌐 Kotlin | 📅 2026-09-14 - Clean, lightweight protocol buffers for Android and Java.
...
* [Chronicle-Queue](https://github.com/OpenHFT/Chronicle-Queue) ⭐ 3,812 | 🐛 47 | 🌐 Java | 📅 2026-09-14 - Micro second messaging that stores everything to disk.
...
* [Chronicle-Map](https://github.com/OpenHFT/Chronicle-Map) ⭐ 2,990 | 🐛 31 | 🌐 Java | 📅 2026-09-14 - In-memory key-value store designed for low-latency and/or multi-process applications.
...
* [Zero-Allocation-Hashing](https://github.com/OpenHFT/Zero-Allocation-Hashing) ⭐ 845 | 🐛 18 | 🌐 Java | 📅 2026-09-14 - Hashing any sequences of bytes in Java, including all kinds of primitive arrays, buffers, CharSequences and more.
...
* [Chronicle-Bytes](https://github.com/OpenHFT/Chronicle-Bytes) ⭐ 437 | 🐛 8 | 🌐 Java | 📅 2026-09-14 - Low level memory access wrappers.
...
* [Truffle](https://github.com/graalvm/truffle) ⭐ 21,702 | 🐛 851 | 🌐 Java | 📅 2026-09-14 - Framework for implementing languages as simple interpreters.
* [JavaPoet](https://github.com/square/javapoet) ⚠️ Archived - A Java API for generating .java source files.
* [auto](https://github.com/google/auto) ⭐ 10,556 | 🐛 88 | 🌐 Java | 📅 2026-09-14 - A collection of source code generators for Java.
* [error-prone](https://github.com/google/error-prone) ⭐ 7,236 | 🐛 533 | 🌐 Java | 📅 2026-09-14 - Catch common Java mistakes as compile-time errors.
* [javaparser](https://github.com/javaparser/javaparser) ⭐ 6,149 | 🐛 448 | 🌐 Java | 📅 2026-09-14 - Java 1.8 Parser and Abstract Syntax Tree for Java.
* [TeaVM](https://github.com/konsoletyper/teavm) ⭐ 3,109 | 🐛 186 | 🌐 Java | 📅 2026-09-14 - Ahead-of-time translating compiler (transpiler) from Java bytecode to JavaScript.
...
* [okhttp](https://github.com/square/okhttp) ⭐ 47,061 | 🐛 152 | 🌐 Kotlin | 📅 2026-09-14 - An HTTP+HTTP/2 client for Android and Java applications.
...
* [armeria](https://github.com/line/armeria) ⭐ 5,138 | 🐛 705 | 🌐 Java | 📅 2026-09-14 - Asynchronous RPC/API client/server library built on top of Java 8, Netty 4.1, HTTP/2, and Thrift.
...
* [async-profiler](https://github.com/jvm-profiling-tools/async-profiler) ⭐ 9,148 | 🐛 61 | 🌐 C++ | 📅 2026-09-14 - Sampling CPU profiler for Java featuring AsyncGetCallTrace + perf\_events.
...
* [J2ObjC](https://github.com/google/j2objc) ⭐ 6,038 | 🐛 148 | 🌐 Java | 📅 2026-09-14 - Translator from Java source to Objective-C code. Keeps shared code between iOS native apps and Android native apps.
* [jvm.go](https://github.com/zxh0/jvm.go) ⭐ 3,598 | 🐛 12 | 🌐 Go | 📅 2019-12-04 - A JVM written in Go.
* [Eclipse OpenJ9](https://github.com/eclipse/openj9) ⭐ 3,546 | 🐛 3,264 | 🌐 Java | 📅 2026-09-14 - Eclipse OpenJ9.
* [ParparVM](https://github.com/codenameone/CodenameOne/tree/master/vm) ⭐ 1,867 | 🐛 287 | 🌐 Java | 📅 2026-09-14 - An Open Source Java bytecode to C translator for iOS native development. Designed as a part of the [Codename One](https://www.codenameone.com/) WORA for mobile project.
