...
* [Smile](https://github.com/haifengl/smile) ⭐ 6,414 | 🐛 2 | 🌐 Java | 📅 2026-09-13 - Statistical Machine Intelligence & Learning Engine.

## Memory and concurrency

*Tools and data structures for efficient memory layout and concurrent access.*

* [RxJava](https://github.com/ReactiveX/RxJava) ⭐ 48,205 | 🐛 11 | 🌐 Java | 📅 2026-09-08 - Library for composing asynchronous and event-based programs using observable sequences.
* [VarInt](https://github.com/bazelbuild/bazel/blob/master/src/main/java/com/google/devtools/build/lib/util/VarInt.java) ⭐ 25,843 | 🐛 1,775 | 🌐 Java | 📅 2026-09-13 - No-deps variable int implementation without deps (by Bazel).
...
* [lwjgl3](https://github.com/LWJGL/lwjgl3) ⭐ 5,449 | 🐛 89 | 🌐 Java | 📅 2026-09-10 - Java library that enables cross-platform access to popular native APIs useful in the development of graphics (OpenGL), audio (OpenAL) and parallel computing (OpenCL) applications.
* [wire](https://github.com/square/wire) ⭐ 4,428 | 🐛 163 | 🌐 Kotlin | 📅 2026-09-10 - Clean, lightweight protocol buffers for Android and Java.
* [failsafe](https://github.com/jhalterman/failsafe) ⭐ 4,312 | 🐛 78 | 🌐 Java | 📅 2025-12-28 - A lightweight, zero-dependency library for handling failures.
* [RoaringBitmap](https://github.com/RoaringBitmap/RoaringBitmap) ⭐ 3,928 | 🐛 78 | 🌐 Java | 📅 2026-09-10 - A better compressed bitset in Java.
* [Chronicle-Queue](https://github.com/OpenHFT/Chronicle-Queue) ⭐ 3,811 | 🐛 47 | 🌐 Java | 📅 2026-09-13 - Micro second messaging that stores everything to disk.
...
* [Chronicle-Map](https://github.com/OpenHFT/Chronicle-Map) ⭐ 2,990 | 🐛 31 | 🌐 Java | 📅 2026-09-13 - In-memory key-value store designed for low-latency and/or multi-process applications.
...
* [Eclipse Collections](https://github.com/eclipse/eclipse-collections) ⭐ 2,651 | 🐛 173 | 🌐 Java | 📅 2026-09-12 - Collections framework for Java.
...
* [DSL-JSON](http://github.com/ngs-doo/dsl-json) ⭐ 1,071 | 🐛 48 | 🌐 Java | 📅 2026-09-13 - High performance JSON library with advanced compile-time databinding.
...
* [Zero-Allocation-Hashing](https://github.com/OpenHFT/Zero-Allocation-Hashing) ⭐ 845 | 🐛 18 | 🌐 Java | 📅 2026-09-13 - Hashing any sequences of bytes in Java, including all kinds of primitive arrays, buffers, CharSequences and more.
...
* [Chronicle-Bytes](https://github.com/OpenHFT/Chronicle-Bytes) ⭐ 437 | 🐛 9 | 🌐 Java | 📅 2026-09-13 - Low level memory access wrappers.
...
* [Truffle](https://github.com/graalvm/truffle) ⭐ 21,700 | 🐛 849 | 🌐 Java | 📅 2026-09-13 - Framework for implementing languages as simple interpreters.
...
* [error-prone](https://github.com/google/error-prone) ⭐ 7,236 | 🐛 534 | 🌐 Java | 📅 2026-09-13 - Catch common Java mistakes as compile-time errors.
* [javaparser](https://github.com/javaparser/javaparser) ⭐ 6,151 | 🐛 449 | 🌐 Java | 📅 2026-09-12 - Java 1.8 Parser and Abstract Syntax Tree for Java.
* [TeaVM](https://github.com/konsoletyper/teavm) ⭐ 3,107 | 🐛 185 | 🌐 Java | 📅 2026-09-13 - Ahead-of-time translating compiler (transpiler) from Java bytecode to JavaScript.
...
* [armeria](https://github.com/line/armeria) ⭐ 5,138 | 🐛 714 | 🌐 Java | 📅 2026-09-13 - Asynchronous RPC/API client/server library built on top of Java 8, Netty 4.1, HTTP/2, and Thrift.
...
* [Zipkin](https://github.com/openzipkin/zipkin) ⭐ 17,458 | 🐛 175 | 🌐 Java | 📅 2026-08-06 - A distributed tracing system gather timing data for disparate services developed by Twitter.
* [async-profiler](https://github.com/jvm-profiling-tools/async-profiler) ⭐ 9,147 | 🐛 58 | 🌐 C++ | 📅 2026-09-09 - Sampling CPU profiler for Java featuring AsyncGetCallTrace + perf\_events.
* [BTrace](https://github.com/jbachorik/btrace) ⭐ 5,995 | 🐛 6 | 🌐 Java | 📅 2026-09-01 - a safe, dynamic tracing tool for the Java platform.
* [micrometer](https://github.com/micrometer-metrics/micrometer) ⭐ 4,899 | 🐛 312 | 🌐 Java | 📅 2026-09-11 - An application metrics facade for the most popular monitoring tools.
...
* [jitwatch](https://github.com/AdoptOpenJDK/jitwatch) ⭐ 3,308 | 🐛 18 | 🌐 Java | 📅 2026-09-09 - Log analyser / visualiser for Java HotSpot JIT compiler.
...
* [J2ObjC](https://github.com/google/j2objc) ⭐ 6,038 | 🐛 148 | 🌐 Java | 📅 2026-09-13 - Translator from Java source to Objective-C code. Keeps shared code between iOS native apps and Android native apps.
* [jvm.go](https://github.com/zxh0/jvm.go) ⭐ 3,598 | 🐛 12 | 🌐 Go | 📅 2019-12-04 - A JVM written in Go.
* [Eclipse OpenJ9](https://github.com/eclipse/openj9) ⭐ 3,546 | 🐛 3,273 | 🌐 Java | 📅 2026-09-12 - Eclipse OpenJ9.
* [ParparVM](https://github.com/codenameone/CodenameOne/tree/master/vm) ⭐ 1,866 | 🐛 290 | 🌐 Java | 📅 2026-09-13 - An Open Source Java bytecode to C translator for iOS native development. Designed as a part of the [Codename One](https://www.codenameone.com/) WORA for mobile project.
...
* [MobiDevelop's RoboVM Fork](https://github.com/MobiVM/robovm) ⭐ 1,042 | 🐛 27 | 🌐 Java | 📅 2026-09-08 - Ahead of time compiler for JVM bytecode targeting iOS, Mac OSX and Linux.
