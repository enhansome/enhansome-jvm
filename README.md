...
* [Smile](https://github.com/haifengl/smile) ⭐ 6,413 | 🐛 0 | 🌐 Java | 📅 2026-08-28 - Statistical Machine Intelligence & Learning Engine.
...
* [VarInt](https://github.com/bazelbuild/bazel/blob/master/src/main/java/com/google/devtools/build/lib/util/VarInt.java) ⭐ 25,770 | 🐛 1,917 | 🌐 Java | 📅 2026-08-28 - No-deps variable int implementation without deps (by Bazel).
* [caffeine](https://github.com/ben-manes/caffeine) ⭐ 17,836 | 🐛 1 | 🌐 Java | 📅 2026-08-27 - A high performance caching library for Java 8.
...
* [lwjgl3](https://github.com/LWJGL/lwjgl3) ⭐ 5,438 | 🐛 85 | 🌐 Java | 📅 2026-08-23 - Java library that enables cross-platform access to popular native APIs useful in the development of graphics (OpenGL), audio (OpenAL) and parallel computing (OpenCL) applications.
* [wire](https://github.com/square/wire) ⭐ 4,428 | 🐛 163 | 🌐 Kotlin | 📅 2026-08-27 - Clean, lightweight protocol buffers for Android and Java.
...
* [Chronicle-Queue](https://github.com/OpenHFT/Chronicle-Queue) ⭐ 3,799 | 🐛 45 | 🌐 Java | 📅 2026-08-27 - Micro second messaging that stores everything to disk.
...
* [Truffle](https://github.com/graalvm/truffle) ⭐ 21,676 | 🐛 850 | 🌐 Java | 📅 2026-08-27 - Framework for implementing languages as simple interpreters.
...
* [error-prone](https://github.com/google/error-prone) ⭐ 7,225 | 🐛 522 | 🌐 Java | 📅 2026-08-27 - Catch common Java mistakes as compile-time errors.
...
* [jnr-ffi](https://github.com/jnr/jnr-ffi) ⭐ 1,324 | 🐛 98 | 🌐 Java | 📅 2026-08-20 - Load native libraries without writing JNI code by hand.
...
* [okhttp](https://github.com/square/okhttp) ⭐ 47,056 | 🐛 141 | 🌐 Kotlin | 📅 2026-08-27 - An HTTP+HTTP/2 client for Android and Java applications.
...
* [armeria](https://github.com/line/armeria) ⭐ 5,133 | 🐛 699 | 🌐 Java | 📅 2026-08-28 - Asynchronous RPC/API client/server library built on top of Java 8, Netty 4.1, HTTP/2, and Thrift.
...
* [bcc](https://github.com/iovisor/bcc) ⭐ 22,641 | 🐛 1,069 | 🌐 C | 📅 2026-08-27 - Tools for BPF-based Linux IO analysis, networking, monitoring, and more.
* [perf-tools](https://github.com/brendangregg/perf-tools) ⭐ 10,463 | 🐛 56 | 🌐 Shell | 📅 2023-11-22 - Performance analysis tools based on Linux perf\_events (aka perf) and ftrace.
...
* [leakcanary](https://github.com/square/leakcanary) ⭐ 29,987 | 🐛 131 | 🌐 Kotlin | 📅 2026-08-27 - A memory leak detection library for Android and Java.
...
* [micrometer](https://github.com/micrometer-metrics/micrometer) ⭐ 4,891 | 🐛 318 | 🌐 Java | 📅 2026-08-28 - An application metrics facade for the most popular monitoring tools.
...
* [jitwatch](https://github.com/AdoptOpenJDK/jitwatch) ⭐ 3,305 | 🐛 16 | 🌐 Java | 📅 2025-12-28 - Log analyser / visualiser for Java HotSpot JIT compiler.
...
* [J2ObjC](https://github.com/google/j2objc) ⭐ 6,039 | 🐛 152 | 🌐 Java | 📅 2026-08-28 - Translator from Java source to Objective-C code. Keeps shared code between iOS native apps and Android native apps.
* [jvm.go](https://github.com/zxh0/jvm.go) ⭐ 3,600 | 🐛 12 | 🌐 Go | 📅 2019-12-04 - A JVM written in Go.
* [Eclipse OpenJ9](https://github.com/eclipse/openj9) ⭐ 3,538 | 🐛 3,250 | 🌐 Java | 📅 2026-08-27 - Eclipse OpenJ9.
* [ParparVM](https://github.com/codenameone/CodenameOne/tree/master/vm) ⭐ 1,860 | 🐛 271 | 🌐 Java | 📅 2026-08-28 - An Open Source Java bytecode to C translator for iOS native development. Designed as a part of the [Codename One](https://www.codenameone.com/) WORA for mobile project.
...
* [An introduction to distributed systems](https://github.com/aphyr/distsys-class) ⭐ 9,879 | 🐛 6 | 📅 2025-03-18 - Kyle Kingsbury (author of Jepsen).
