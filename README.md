...
* [wrk2](https://github.com/giltene/wrk2) ⭐ 4,625 | 🐛 106 | 🌐 C | 📅 2024-03-03 - A constant throughput, correct latency recording variant of wrk.
...
* [Smile](https://github.com/haifengl/smile) ⭐ 6,413 | 🐛 0 | 🌐 Java | 📅 2026-08-21 - Statistical Machine Intelligence & Learning Engine.

## Memory and concurrency

*Tools and data structures for efficient memory layout and concurrent access.*

* [RxJava](https://github.com/ReactiveX/RxJava) ⭐ 48,204 | 🐛 10 | 🌐 Java | 📅 2026-08-21 - Library for composing asynchronous and event-based programs using observable sequences.
* [VarInt](https://github.com/bazelbuild/bazel/blob/master/src/main/java/com/google/devtools/build/lib/util/VarInt.java) ⭐ 25,741 | 🐛 1,935 | 🌐 Java | 📅 2026-08-21 - No-deps variable int implementation without deps (by Bazel).
* [caffeine](https://github.com/ben-manes/caffeine) ⭐ 17,826 | 🐛 1 | 🌐 Java | 📅 2026-08-21 - A high performance caching library for Java 8.
* [okio](https://github.com/square/okio) ⭐ 9,034 | 🐛 103 | 🌐 Kotlin | 📅 2026-08-21 - Modern Java IO library that do clever things to save CPU and memory.
* [Agera](https://github.com/google/agera) ⚠️ Archived - Reactive Programming for Android by Google.
* [lwjgl3](https://github.com/LWJGL/lwjgl3) ⭐ 5,431 | 🐛 84 | 🌐 Java | 📅 2026-08-21 - Java library that enables cross-platform access to popular native APIs useful in the development of graphics (OpenGL), audio (OpenAL) and parallel computing (OpenCL) applications.
* [wire](https://github.com/square/wire) ⭐ 4,427 | 🐛 164 | 🌐 Kotlin | 📅 2026-08-20 - Clean, lightweight protocol buffers for Android and Java.
* [failsafe](https://github.com/jhalterman/failsafe) ⭐ 4,307 | 🐛 79 | 🌐 Java | 📅 2025-12-28 - A lightweight, zero-dependency library for handling failures.
...
* [Simple Binary Encoding](https://github.com/real-logic/simple-binary-encoding) ⭐ 3,491 | 🐛 39 | 🌐 Java | 📅 2026-08-21 - High Performance Message Codec.
...
* [hollow](https://github.com/Netflix/hollow) ⭐ 1,366 | 🐛 160 | 🌐 Java | 📅 2026-08-19 - Java library and comprehensive toolset for harnessing small to moderately sized in-memory datasets.
...
* [geohash](https://github.com/davidmoten/geo) ⭐ 434 | 🐛 9 | 🌐 Java | 📅 2026-08-21 - Java utility methods for geohashing.
...
* [Truffle](https://github.com/graalvm/truffle) ⭐ 21,667 | 🐛 851 | 🌐 Java | 📅 2026-08-21 - Framework for implementing languages as simple interpreters.
...
* [error-prone](https://github.com/google/error-prone) ⭐ 7,225 | 🐛 519 | 🌐 Java | 📅 2026-08-21 - Catch common Java mistakes as compile-time errors.
* [javaparser](https://github.com/javaparser/javaparser) ⭐ 6,140 | 🐛 449 | 🌐 Java | 📅 2026-08-18 - Java 1.8 Parser and Abstract Syntax Tree for Java.
...
* [parboiled](https://github.com/sirthias/parboiled) ⭐ 1,318 | 🐛 41 | 🌐 Java | 📅 2026-08-21 - Parsing of arbitrary input text based on parsing expression grammars.
...
* [okhttp](https://github.com/square/okhttp) ⭐ 47,046 | 🐛 136 | 🌐 Kotlin | 📅 2026-08-21 - An HTTP+HTTP/2 client for Android and Java applications.
* [gor](https://github.com/buger/gor) ⭐ 19,317 | 🐛 341 | 🌐 Go | 📅 2026-01-27 - HTTP traffic replay in real-time.
...
* [likwid](https://github.com/RRZE-HPC/likwid) ⭐ 1,933 | 🐛 92 | 🌐 C | 📅 2026-08-19 - Read hardware performance counters on Intel and AMD processors.
...
* [leakcanary](https://github.com/square/leakcanary) ⭐ 29,978 | 🐛 131 | 🌐 Kotlin | 📅 2026-08-21 - A memory leak detection library for Android and Java.
...
* [async-profiler](https://github.com/jvm-profiling-tools/async-profiler) ⭐ 9,123 | 🐛 58 | 🌐 C++ | 📅 2026-08-21 - Sampling CPU profiler for Java featuring AsyncGetCallTrace + perf\_events.
* [BTrace](https://github.com/jbachorik/btrace) ⭐ 5,992 | 🐛 7 | 🌐 Java | 📅 2026-08-17 - a safe, dynamic tracing tool for the Java platform.
* [micrometer](https://github.com/micrometer-metrics/micrometer) ⭐ 4,882 | 🐛 320 | 🌐 Java | 📅 2026-08-21 - An application metrics facade for the most popular monitoring tools.
...
* [J2ObjC](https://github.com/google/j2objc) ⭐ 6,039 | 🐛 150 | 🌐 Java | 📅 2026-08-21 - Translator from Java source to Objective-C code. Keeps shared code between iOS native apps and Android native apps.
* [jvm.go](https://github.com/zxh0/jvm.go) ⭐ 3,600 | 🐛 12 | 🌐 Go | 📅 2019-12-04 - A JVM written in Go.
* [Eclipse OpenJ9](https://github.com/eclipse/openj9) ⭐ 3,536 | 🐛 3,257 | 🌐 Java | 📅 2026-08-21 - Eclipse OpenJ9.
* [ParparVM](https://github.com/codenameone/CodenameOne/tree/master/vm) ⭐ 1,860 | 🐛 267 | 🌐 Java | 📅 2026-08-21 - An Open Source Java bytecode to C translator for iOS native development. Designed as a part of the [Codename One](https://www.codenameone.com/) WORA for mobile project.
...
Please have a look at [contributing.md](https://github.com/deephacks/awesome-jvm/blob/master/contributing.md) ⭐ 2,174 | 🐛 17 | 📅 2022-08-30 for guidelines.
